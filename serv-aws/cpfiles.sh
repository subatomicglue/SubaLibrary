...
aws s3 cp ../serv/build/notfound.html "s3://$BUCKET_NAME/" --cache-control 'no-cache'   --content-type 'text/html' $METADATA_FOR_HTML
aws s3 cp ../serv/build/forbidden.html "s3://$BUCKET_NAME/" --cache-control 'no-cache'   --content-type 'text/html' $METADATA_FOR_HTML

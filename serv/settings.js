...
module.exports = {
  ...
  HTTP_PORT: process.env.NODE_HTTP_PORT || process.env.NODE_PORT || config.PORT_DEFAULT, // Override default port with environment variable
  HTTPS_PORT: process.env.NODE_HTTPS_PORT || config.HTTPS_PORT_DEFAULT, // Override default port with environment variable
